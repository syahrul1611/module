            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.v1.access.category.update',$data->id) }}" enctype="multipart/form-data">
                            @csrf  
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="desc" type="text" class="form-control form-control-user @error('desc') is-invalid @enderror" name="desc" value="{{ $data->desc }}" autocomplete="desc">
                                    @error('desc')
                                        <span class="invalid-feedback" status="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
