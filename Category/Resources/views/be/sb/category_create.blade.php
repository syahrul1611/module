            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.v1.access.category.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 offset-md-12">
                                    <a href="{{ route('admin.v1.access.category.index') }}" type="submit" class="btn btn-user btn-danger btn-block text-white">
                                        {{ __('Back') }}
                                    </a>
                                </div>
                            </div>
