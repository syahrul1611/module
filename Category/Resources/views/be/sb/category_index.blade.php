                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      ...
                      <div class="btn-group btn-sm nospiner" >
                        <a  href="{{ route('admin.v1.access.category.create') }}"  class="btn btn-success btn-sm" >
                          <i class="fas fa-fw fa-plus"></i> Add Category
                        </a>
                        <button type="submit" form="selection" formmethod="post" formaction="{{ route('admin.v1.access.category.delete.selected') }}" onclick="return confirm('Confirm Delete')" class="btn btn-danger btn-sm">
                                ...
                                <tr>
                                    ...
                                    <th width="5%" class="text-center align-middle">
                                      <div class="btn-group nospiner" >
                                        ...
                                        <a  href="{{ route('admin.v1.access.category.index') }}"  class="btn btn-sm btn-danger">
                                        ...
                                        <td align="center">
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="{{ route('admin.v1.access.category.edit',$data->id) }}" class="dropdown-item">Edit</a>
                                              <a href="{{ route('admin.v1.access.category.delete',$data->id) }}" onclick="return confirm('Confirm Delete')" class="dropdown-item">Delete</a>                                              
                                            </div>
                                          </div>
                                        </td>
                                    </tr>
