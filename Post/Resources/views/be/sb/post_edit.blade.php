            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.v1.access.post.update',$data->id) }}" enctype="multipart/form-data">
                            @csrf  
                            @method('PUT')
                            <div class="form-group row">
                                <label for="title" class="col-md-3 col-form-label text-md-right">{{ __('Title') }}</label>
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="title" type="text" class="form-control form-control-user @error('title') is-invalid @enderror" name="title" value="{{ $data->title }}" autocomplete="title">
                                    @error('title')
                            ...
                            <div class="form-group row" style="margin-bottom: 60px;">
                                <label for="image" class="col-md-3 col-form-label text-md-right">{{ __('Foto') }}</label>
                                <div class="col-md-8 mb-3 mb-sm-0" style="text-align:center;padding:10px;">
                                    <img src="{{ route('admin.v1.access.post.file',$data->image) }}" width="100%" height="100%" style="padding:10px;"/>
                                    <input id="image" type="file" class="form-control form-control-user @error('image') is-invalid @enderror" name="image" value="{{ $data->image }}" autocomplete="image">
                                    @error('image')
                                        <span class="invalid-feedback" status="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <textarea id="content" class="form-control form-control-user @error('content') is-invalid @enderror" name="content" value="{{ $data->content }}" required autocomplete="content" autofocus>{!! $data->content !!}</textarea>
                                    @error('content')
                                        <span class="invalid-feedback" status="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <select name="category" id="category" class="form-control form-control-user @error('category') is-invalid @enderror" value="{{ $data->category->name }}" required autocomplete="category">
